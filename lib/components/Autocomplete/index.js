...
export const Autocomplete = memo((_a) => {
    var { value, disabled, label, solo, delay = 300, items, solid, onChange, onSearch, renderItem, color = "primary", flatListProps, clearText, clearable, children } = _a, props = __rest(_a, ["value", "disabled", "label", "solo", "delay", "items", "solid", "onChange", "onSearch", "renderItem", "color", "flatListProps", "clearText", "clearable", "children"]);

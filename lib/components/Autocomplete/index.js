...
exports.Autocomplete = (0, react_1.memo)(({ value, disabled, label, solo, delay = 500, items, onChange, onSearch, renderItem, color = "primary", flatListProps, clearText, clearable, children, ...props }) => {
    ...
    const filteredItems = (0, react_1.useMemo)(() => currentItems?.filter(({ label: label2 }) => label2 !== currentText &&
        label2
            .toLowerCase()
            .normalize("NFD")
            .includes(currentText.toLowerCase().normalize("NFD"))), [currentItems, currentText]);
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { ref: ref, style: styles.container, children: [children || ((0, jsx_runtime_1.jsx)(TextField_1.TextField, { ...props, label: label, disabled: disabled, color: color, value: currentText, onFocus: openPopover, onBlur: onBlur, onChange: onChangeText })), (0, jsx_runtime_1.jsx)(Popover_1.Popover, { solo: true, parentRef: ref, open: isFocused && !!filteredItems.length, children: (0, jsx_runtime_1.jsx)(react_native_1.FlatList, { data: filteredItems, removeClippedSubviews: true, renderItem: renderOption, style: styles.list, ...flatListProps }) })] }));
});

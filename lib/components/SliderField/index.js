...
export const SliderField = memo((_a) => {
    ...
    const defaultText = (value === null || value === void 0 ? void 0 : value.toString()) || minValue.toString();

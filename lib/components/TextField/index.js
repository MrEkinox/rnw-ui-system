...
export const TextField = memo((_a) => {
    ...
    const maxCountText = useMemo(() => displayMaxCount && props.maxLength ? (_jsx(Badge, Object.assign({ style: styles.countText, color: currentColor, textVariant: "overline", size: 10 }, { children: `${value.length}/${props.maxLength}` }))) : null, [currentColor, displayMaxCount, props.maxLength, value.length]);

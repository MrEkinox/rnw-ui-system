...
export const TextField = memo((_a) => {
    var { value = "", disabled, onChange, label, editable = true, startIcon, endIcon, required, displayMaxCount, error, onBlur, onFocus, helperText, containerStyle, autoGrow, color = "primary", name, keyboardType } = _a, props = __rest(_a, ["value", "disabled", "onChange", "label", "editable", "startIcon", "endIcon", "required", "displayMaxCount", "error", "onBlur", "onFocus", "helperText", "containerStyle", "autoGrow", "color", "name", "keyboardType"]);
    const theme = useTheme();
    ...
    const badgeStyle = useThemeStyle((curTheme) => [
        styles.countText,
        { borderBottomRightRadius: curTheme.borderRadius / 1.5 },
    ], []);
    const maxCountText = useMemo(() => displayMaxCount && props.maxLength ? (_jsx(Badge, Object.assign({ style: badgeStyle, color: currentColor, textVariant: "overline" }, { children: `${value.length}/${props.maxLength}` }))) : null, [currentColor, badgeStyle, displayMaxCount, props.maxLength, value.length]);
    return (_jsxs(_Fragment, { children: [_jsxs(View, Object.assign({ style: style }, { children: [memoStartIcon, _jsxs(View, Object.assign({ style: flexStyle }, { children: [_jsx(TextFieldLabel, Object.assign({ required: required, isActive: labelIsActive, disabled: disabled, color: color, error: error }, { children: label })), _jsx(TextInput, Object.assign({ accessibilityLabel: label, nativeID: name }, props, { keyboardType: keyboardType, onChangeText: onChangeValue, onBlur: onMemoBlur, onFocus: onMemoFocus, style: inputStyle, onContentSizeChange: onContentSizeChange, placeholderTextColor: placeholderTextColor, value: value, editable: canEdit, selectionColor: themeColor }))] })), memoEndIcon || maxCountText] })), _jsx(TextFieldHelper, Object.assign({ color: color, error: error }, { children: helperText }))] }));
});

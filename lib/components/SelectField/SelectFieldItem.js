...
export const SelectFieldItem = memo((_a) => {
    ...
    return (_jsx(Pressable, Object.assign({ disabled: disabled, onPress: onClick }, hover.handlers, props, { style: style }, { children: typeof children === "string" ? (_jsx(Typography, Object.assign({ variant: "subtitle2" }, { children: children }))) : (children) })));
});

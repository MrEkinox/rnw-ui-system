...
export const SelectFieldItem = memo(({ children, value, onPress, color = "primary", selected, ...props }) => {
    ...
    return (_jsx(Pressable, { onPress: onClick, ...hover.handlers, ...props, style: style, children: typeof children === "string" ? (_jsx(Typography, { children: children })) : (children) }));
});

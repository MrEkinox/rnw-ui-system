...
export const SelectField = memo((_a) => {
    var { value, disabled, label, items, multiple, searchable, onChange, renderItem, color = "primary", flatListProps, clearText, clearable, children, onTouchStart, onTouchEnd, onHoverIn, onHoverOut } = _a, props = __rest(_a, ["value", "disabled", "label", "items", "multiple", "searchable", "onChange", "renderItem", "color", "flatListProps", "clearText", "clearable", "children", "onTouchStart", "onTouchEnd", "onHoverIn", "onHoverOut"]);
    const theme = useTheme();

...
export const Chip = memo((_a) => {
    var { children, size, disabled, variant, color = "primary" } = _a, props = __rest(_a, ["children", "size", "disabled", "variant", "color"]);
    ...
    return (_jsx(Pressable, Object.assign({}, hover.handlers, { disabled: disabled || !props.onPress, nativeID: "chip" }, props, { style: style }, { children: content })));
});

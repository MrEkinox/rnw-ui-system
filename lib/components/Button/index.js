...
export const Button = memo(({ children, color = "primary", disabled, endIcon, startIcon, fullWidth, loadingPosition = "center", loadingIndicator, size = "medium", variant = "contained", loading, style = {}, ...props }) => {
    ...
    const content = useMemo(() => typeof children === "string" ? (_jsx(Typography, { color: iconProps.color, style: fontStyle, selectable: false, children: children })) : (renderChildren(children, iconProps)), [children, fontStyle, iconProps]);

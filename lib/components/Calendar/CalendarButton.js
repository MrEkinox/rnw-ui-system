...
export const CalendarButton = memo(({ value, type }) => {
    ...
    return (_jsx(View, Object.assign({ style: containerStyle }, { children: _jsx(Button, Object.assign({ onPress: onClick, disabled: disabled, fullWidth: true, style: styles.btn, variant: selected ? "contained" : "hovered", color: color }, { children: _jsx(Typography, Object.assign({ color: fontColor, style: textStyle }, { children: dayjs(value).format(format) })) })) })));
});

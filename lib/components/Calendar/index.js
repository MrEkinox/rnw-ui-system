...
export const Calendar = memo((_a) => {
    var { style, onSingleChange, onRangeChange, maxDate = MAX_DATE, minDate = MIN_DATE, value, endDate, interactive, mode = "single", startDate, color = "primary" } = _a, props = __rest(_a, ["style", "onSingleChange", "onRangeChange", "maxDate", "minDate", "value", "endDate", "interactive", "mode", "startDate", "color"]);

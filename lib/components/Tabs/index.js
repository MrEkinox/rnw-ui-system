...
export const Tabs = memo((_a) => {
    var { value, items, disabled, onChange, color = "primary", style } = _a, props = __rest(_a, ["value", "items", "disabled", "onChange", "color", "style"]);
    ...
    return (_jsxs(ScrollView, Object.assign({ horizontal: true }, props, { contentContainerStyle: containerStyle }, { children: [selectedIndex !== -1 && _jsx(Animated.View, { style: colorStyle }), items.map((item, index) => (_jsx(Tab, Object.assign({ value: item.value, disabled: disabled, selected: index === selectedIndex, color: themeColor, onPress: onChangeIndex, onLayout: onLayout }, { children: item.label }), index)))] })));
});

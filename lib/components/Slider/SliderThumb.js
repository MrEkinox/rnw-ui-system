...
export const SliderThumb = memo(({ color, value, maxValue, minValue, inInteraction, step, getLabel }) => {
    ...
    return (_jsx(Animated.View, { onLayout: onLayout, style: style, children: typeof label === "string" || typeof label === "number" ? (_jsx(Typography, { color: fontColor, variant: "overline", selectable: false, children: label })) : (label) }));
});

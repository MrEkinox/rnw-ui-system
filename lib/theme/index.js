...
export const ThemeProvider = memo(({ children, mode = "auto", theme, ...props }) => {
    ...
    return (_jsx(ThemeContext.Provider, { value: combinedTheme, children: _jsx(SnackbarProvider, { children: _jsx(View, { style: style, children: children }) }) }));
});

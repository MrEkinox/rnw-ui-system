...
export const ThemeProvider = memo((_a) => {
    var _b;
    var { children, mode = "auto", theme } = _a, props = __rest(_a, ["children", "mode", "theme"]);
    ...
    return (_jsx(ThemeContext.Provider, Object.assign({ value: combinedTheme }, { children: _jsx(SnackbarProvider, { children: _jsx(View, Object.assign({ style: style }, { children: children })) }) })));
});
